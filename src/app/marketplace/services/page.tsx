...
function ServiceCardSkeleton(): React.JSX.Element {
  return (
...
export default function BrowseServicesPage(): React.JSX.Element {
  ...
  const fetchMoreServices = useCallback(
    (cursor: string) =>
      getPublicServices({
        category: filters.category || undefined,
        minPrice: filters.minBudget > 0 ? filters.minBudget : undefined,
  ...
  const { loadMore } = useMarketplaceCursorLoadMore({
    hasMore,
    nextCursor,
    fetchPage: fetchMoreServices,
    onAppend: (items) => setServices((prev) => [...prev, ...items]),
    onMetaChange: ({ hasMore: more, nextCursor: cursor }) => {
      setHasMore(more);
      setNextCursor(cursor);
    },
    errorMessage: "Failed to load more services:",
  });
          ...
          <div className="max-w-[1380px] mx-auto">
            ...
            <div className="max-w-3xl mb-6">
              ...
              <p className="text-base text-text-secondary leading-relaxed">
                Connect with verified, high-caliber freelancers ready to execute your projects on demand with secure escrow protection.
              </p>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-6 mb-7 text-xs text-text-secondary font-medium">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>Direct Client-Freelancer Chat</span>
              </div>
            </div>
            ...
            <SearchBar
              ...
              onClear={clearSearch}
              placeholder="Search services by title, skills, or keywords..."
            />
            ...
            <div className="flex-1 min-w-0 space-y-6">
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 p-4 rounded-2xl bg-white/70 backdrop-blur-sm shadow-[3px_3px_6px_#d1d5db,-3px_-3px_6px_#ffffff]">
                <div className="flex flex-wrap items-center gap-2">
                  <span className="text-xs font-bold text-text-primary">
                    {isLoading ? "Searching..." : `${services.length} ${services.length === 1 ? "service" : "services"} found`}
                  </span>
              ...
              {isLoading ? (
                ...
                <EmptyState
                  ...
                  message="Try adjusting your filters or search terms to find available talent"
                  variant="card"
