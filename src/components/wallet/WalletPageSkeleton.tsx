...
export function WalletPageSkeleton(): React.JSX.Element {
  return (
    <div className="w-full max-w-7xl mx-auto space-y-6 animate-pulse" aria-hidden>
      ...
      {/* Master Balance Card */}
      <div className="h-56 rounded-3xl bg-white dark:bg-slate-900 shadow-[var(--shadow-neumorphic-light)] dark:shadow-[var(--shadow-neumorphic-dark)]" />

      {/* 3 Metric Cards */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        <div className="h-36 rounded-3xl bg-white dark:bg-slate-900 shadow-[var(--shadow-neumorphic-light)] dark:shadow-[var(--shadow-neumorphic-dark)]" />
        <div className="h-36 rounded-3xl bg-white dark:bg-slate-900 shadow-[var(--shadow-neumorphic-light)] dark:shadow-[var(--shadow-neumorphic-dark)]" />
        <div className="h-36 rounded-3xl bg-white dark:bg-slate-900 shadow-[var(--shadow-neumorphic-light)] dark:shadow-[var(--shadow-neumorphic-dark)]" />
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        <div className="h-84 rounded-3xl bg-white dark:bg-slate-900 shadow-[var(--shadow-neumorphic-light)] dark:shadow-[var(--shadow-neumorphic-dark)]" />
        <div className="h-84 rounded-3xl bg-white dark:bg-slate-900 shadow-[var(--shadow-neumorphic-light)] dark:shadow-[var(--shadow-neumorphic-dark)]" />
      </div>
    </div>
  );
